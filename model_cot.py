...
def JiTCoT_S_16(**kwargs):
    return JiTCoT(depth=12, hidden_size=384, num_heads=6,
               bottleneck_dim=128, in_context_len=32, in_context_start=4, patch_size=16, **kwargs)


def JiTCoT_B_16(**kwargs):
    return JiTCoT(depth=12, hidden_size=768, num_heads=12,
               bottleneck_dim=128, in_context_len=32, in_context_start=4, patch_size=16, **kwargs)

def JiTCoT_BM_16(**kwargs):
    return JiTCoT(depth=8, hidden_size=768, num_heads=12,
               bottleneck_dim=128, in_context_len=32, in_context_start=4, patch_size=16, **kwargs)
...
def JiTCoT_L_16(**kwargs):
    return JiTCoT(depth=24, hidden_size=1024, num_heads=16,
               bottleneck_dim=128, in_context_len=32, in_context_start=8, patch_size=16, **kwargs)

def JiTCoT_LM_16(**kwargs):
    return JiTCoT(depth=20, hidden_size=1024, num_heads=16,
               bottleneck_dim=128, in_context_len=32, in_context_start=8, patch_size=16, **kwargs)
...
def JiTCoT_H_16(**kwargs):
    return JiTCoT(depth=32, hidden_size=1280, num_heads=16,
