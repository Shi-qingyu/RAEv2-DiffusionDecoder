...
def build_mlp_repa(hidden_size, projector_dim, z_dim):
...
class JiT(nn.Module):
    ...
    def __init__(
        ...
        # repa
        self.repa_projection = build_mlp_repa(hidden_size, 2048, 768)
    ...
    def forward(self, x, t, y, return_repa=False):
        ...
        for i, block in enumerate(self.blocks):
            ...
            if self.in_context_len > 0 and i == self.in_context_start:
                repa_out = self.repa_projection(x)
...
def JiTRepa_H_32(**kwargs):
    return JiT(depth=32, hidden_size=1280, num_heads=16,
               bottleneck_dim=256, in_context_len=32, in_context_start=10, patch_size=32, **kwargs)


JiT_models = {
    'JiTRepa-B/16': JiTRepa_B_16,
    'JiTRepa-B/32': JiTRepa_B_32,
    'JiTRepa-L/16': JiTRepa_L_16,
    'JiTRepa-L/32': JiTRepa_L_32,
    'JiTRepa-H/16': JiTRepa_H_16,
    'JiTRepa-H/32': JiTRepa_H_32,
}
